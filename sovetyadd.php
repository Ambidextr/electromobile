...
//--------------------Панель загрузки новой статьи ----------------------------------
	...
	{
		echo '<div id="pagin">';
	 echo '<h2><p><b> Форма для загрузки статей </b></p></h2></br>
      <form action="upload_sovety.php" method="post" enctype="multipart/form-data">
	  Выберите изображение:</br>
      <input type="file" name="filename" required></br> 
	  Введите время создания статьи:</br>
	  <input type="date" name="time" required></br>
	  Введите название новости:</Br>
	  <input type="text" name="name_sovety" placeholder="Название статьи" style="width: 420px" maxlength="150" required></br>
	  ...
	  <option value="Без категории">Без категории</option>';
           ...
           echo '</select></br>
	  Текст новости:</br>
	  <p><textarea rows="20" cols="50" name="text_sovety" maxlength="15000" placeholder="Введите описание статьи" required></textarea></p>	  
