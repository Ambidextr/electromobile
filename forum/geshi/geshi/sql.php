...
$language_data = array (
	...
	'KEYWORDS' => array(
		1 => array(
			'ALL', 'ASC', 'AS',  'ALTER', 'AND', 'ADD', 'AUTO_INCREMENT', 'AVG', 'ANY', 'ALL',
			'BETWEEN', 'BINARY', 'BOTH', 'BY', 'BOOLEAN',
			'CHANGE', 'CHECK', 'COLUMNS', 'COLUMN', 'CROSS','CREATE', 'CASCADES', 'CASCADED', 'COUNT',
			...
			'OPTIMIZE', 'OPTION', 'OPTIONALLY', 'ORDER', 'OUTFILE', 'OR', 'OUTER', 'ON', 'OF',
			'PROCEEDURE','PROCEDURAL', 'PRIMARY', 'PRIVILEGES', 'PUBLIC',
			'READ', 'REFERENCES', 'REGEXP', 'RENAME', 'REPLACE', 'RETURN', 'REVOKE', 'RLIKE', 'RIGHT', 'RESTRICTED',
			'SHOW', 'SONAME', 'STATUS', 'STRAIGHT_JOIN', 'SELECT', 'SETVAL', 'SET', 'SUM',
	...
	'STYLES' => array(
		'KEYWORDS' => array(
			1 => 'color: #A000A0; font-weight: bold;'
			),
		'COMMENTS' => array(
