...
<a href=#><img src="/images/renault-zoe-1.jpg" width="140" height="100"></a>				
	...
	<div id="content">
<div id="pagin">
	<h2><center>Карта зарядных станций</center></h2></br>
	<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=ENQKynKQOlciDpW9OEg_JnwMfGSuypDB&width=585&height=450"></script></br>
	<p>Уважаемые посетители, если Вам известны адреса зарядных станций, которых нет на нашем сайте, сообщите о них в <b><a href="/forum/index.php?action=showTheme&idForum=3&id_theme=7">этой теме на форуме</a></b></p>
	</div>
	</div>
	</div>
	<!-- end #sidebar -->
