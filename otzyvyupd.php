...
<?php
	...
	<div id="pagin">
		...
		<form method="get" name="upd">
            ...
            <?php
                $query = mysql_query("SELECT id_otzyvy, otzyvy_name FROM otzyvy");
...
{
$upd_query = mysql_query("UPDATE otzyvy SET otzyvy_name='".$_POST['name_news']."', otzyvy_text='".$_POST['text']."', otzyvy_picture='".$_FILES["filename"]["name"]."', otzyvy_data='".$_POST['date']."', auto_kategory='".$_POST['auto']."', otzyvy_ocenka='".$_POST['ocenka']."' WHERE id_otzyvy='".$_POST['id']."'") or die(mysql_error());
        if ($upd_query) 
		{
...
{
$upd_query = mysql_query("UPDATE otzyvy SET otzyvy_name='".$_POST['name_news']."', otzyvy_text='".$_POST['text']."', otzyvy_data='".$_POST['date']."', auto_kategory='".$_POST['auto']."', otzyvy_ocenka='".$_POST['ocenka']."' WHERE id_otzyvy='".$_POST['id']."'") or die(mysql_error());
        if ($upd_query) 
		{
			echo "Обновление прошло успешно";
        }
