...
?>
	...
	<div id="content">
	<div id="pagin">
<form method="post" action="delete_gallery.php" name="delete_photo">
            <select name="select_photo" width="100%">
            <?php
                $query = mysql_query("SELECT id_photo, photo_path FROM gallery");
                while ($row = mysql_fetch_assoc($query)) {
                    echo "
                    <option value=".$row['id_photo'].">".$row['photo_path']."</option>
                    ";
                }
            ?>
                </select>
