...
//--------------------Панель загрузки новой новости ----------------------------------
	...
	if($_SESSION["SS_user_id"]==1)
	{
	 ...
	 echo '<div id="content" class="post"><h2><p><b> Форма для загрузки новостей </b></p></h2></br>
      <form action="upload_news.php" method="post" enctype="multipart/form-data">
	  Выберите изображение:</br>
      <input type="file" name="filename" style="width: 420px" required></br>
	   Введите время создания новости:</Br>
	  <input type="date" name="time" required></br>
	  Введите название новости:</Br>
	  <input type="text" name="name_news" placeholder="Название новости" style="width: 420px" maxlength="150" required></br>
	  ...
	  <option value="Без категории">Без категории</option>';
           ...
           echo '</select></br>
	  Текст новости:</br>
	  <p><textarea rows="20" cols="50" name="text_news" maxlength="15000" placeholder="Введите текст новости" required></textarea></p></br>
